...
<body class="min-h-screen bg-zinc-950 text-white">
  ...
  >
    ...
    <div class="flex-1 overflow-y-auto custom-scrollbar px-3 space-y-2" id="sidebar-scroll">
      ...
      @endcanany
@canany(['ver-monitor-turnero','ver-cola-turnero'])
  {{-- Sugerencia para el grupo: clock o queue-list --}}
  <x-sidebar.group id="turnos" icon="clock" text="Turnos"> 
    
    @can('ver-monitor-turnero')
    <flux:navlist.item
        icon="computer-desktop" 
        :href="route('turnos.turnero.monitor')"
        :current="request()->routeIs('turnos.turnero.monitor')"
        wire:navigate
    ...
    <flux:navlist.item
        icon="ticket"
        :href="route('turnos.turnero.index')"
        :current="request()->routeIs('turnos.turnero.index')"
        wire:navigate
        class="nav-item-child"
    >
      Ver mis Tickets
