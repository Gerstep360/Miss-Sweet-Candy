<x-layouts.app :title="__('Crear Pedido de Mesa')">
    <!-- Script DEBE ir ANTES del HTML que lo usa -->
    <script>
    ...
    <div class="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                <h1 class="text-2xl sm:text-3xl font-bold text-white">Nuevo Pedido de Mesa</h1>
                                <p class="text-sm text-zinc-400">Registra un pedido para una mesa</p>
                            </div>
                        </div>
                    </div>
            ...
            <form action="{{ route('pedidos.mesa.store') }}" 
                  method="POST"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea name="notas" 
                                              ...
                                              placeholder="Alergias, preferencias, instrucciones especiales...">{{ old('notas') }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                                    <p class="text-blue-300 text-xs leading-relaxed">
                                        <strong>Nota:</strong> Al crear el pedido, la mesa seleccionada cambiará automáticamente a estado "ocupada".
                                    </p>
                                </div>
                            </div>
                        </div>
