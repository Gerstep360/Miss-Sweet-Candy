<x-layouts.app :title="__('Crear Pedido de Mostrador')">
    <!-- Script DEBE ir ANTES del HTML -->
    <script>
        function pedidoMostradorForm() {
            return {
                items: [],
                errors: {},
                ...
                init() {
                    ...
                    window.addEventListener('products-selected', (event) => {
                        if (event.detail && Array.isArray(event.detail)) {
                            ...
                            console.log('✅ Productos recibidos en mostrador:', this.items.length);
                        }
                    });
                    ...
                    console.log('🛒 Formulario de mostrador iniciado');
                },
                ...
                onSubmit(e) {
                    ...
                    console.log('📝 Enviando pedido con', this.items.length, 'productos');
                }
            }
        }
    </script>
    ...
    <div class="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                <h1 class="text-2xl sm:text-3xl font-bold text-white">Nuevo Pedido de Mostrador</h1>
                                <p class="text-sm text-zinc-400">Registra un pedido para llevar</p>
                            </div>
                        </div>
                    </div>
            ...
            <form action="{{ route('pedidos.mostrador.store') }}" 
                  method="POST"
                  x-data="pedidoMostradorForm()"
                  x-init="init()"
                  @submit="onSubmit">
                @csrf
                        ...
                        <div class="dashboard-card">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-zinc-500">Opcional: para pedidos de clientes frecuentes</p>
                                </div>

                                <div>
                                    <label class="block text-zinc-300 font-medium mb-2">Teléfono de contacto</label>
                                    <input type="tel" 
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea name="notas" 
                                              rows="3" 
                                              class="w-full bg-zinc-800 border border-zinc-700 rounded-lg px-3 py-2.5 text-white focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all resize-none"
                                              placeholder="Instrucciones especiales, comentarios...">{{ old('notas') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="dashboard-card">
                            ...
                            <div class="space-y-3 max-h-[500px] overflow-y-auto custom-scrollbar">
                                ...
                                <div x-show="items.length === 0" 
                                    ...
                                    <p class="text-sm text-zinc-500">Haz clic en "Agregar Productos" para comenzar</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="space-y-3">
                                    <button type="submit" 
                                            ...
                                            class="w-full bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 disabled:from-zinc-700 disabled:to-zinc-600 disabled:cursor-not-allowed text-white py-3 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-amber-500/30 disabled:shadow-none hover:scale-105 active:scale-95 disabled:hover:scale-100 font-semibold">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="bg-amber-500/10 border border-amber-500/30 rounded-lg p-3">
                                    <p class="text-amber-300 text-xs leading-relaxed">
                                        <strong>Nota:</strong> Los pedidos de mostrador son para llevar. El cliente puede retirar su pedido cuando esté listo.
                                    </p>
                                </div>
                            </div>
                        </div>
