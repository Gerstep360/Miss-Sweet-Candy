<x-layouts.app :title="__('Editar Pedido de Mostrador #' . $pedido->id)">
        ...
        function pedidoMostradorForm() {
            return {
                ...
                init() {
                    ...
                    console.log('✏️ Formulario de edición mostrador iniciado con', this.items.length, 'productos');
                },
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-zinc-400">Pedido de Mostrador - {{ $pedido->created_at->format('d/m/Y H:i') }}</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="tel" 
                                           ...
                                           value="{{ $pedido->telefono_contacto }}"
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea name="notas" 
                                              ...
                                              placeholder="Instrucciones especiales, comentarios...">{{ $pedido->notas }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="bg-amber-500/10 border border-amber-500/30 rounded-lg p-3">
                                    <p class="text-amber-300 text-xs leading-relaxed">
                                        <strong>Nota:</strong> Los cambios se aplicarán inmediatamente al pedido de mostrador.
                                    </p>
                                </div>
                            </div>
                        </div>
