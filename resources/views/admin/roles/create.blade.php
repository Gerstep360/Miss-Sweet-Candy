{{-- filepath: c:\Users\German\Documents\Proyectos\PHP\Cafeteria\cafeteria\resources\views\admin\roles\create.blade.php --}}
<x-layouts.app :title="__('Crear Rol - Café Aroma')">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="dashboard-card mb-8">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white">Crear Rol</h1>
                        <p class="text-zinc-300">Define un nuevo rol y asigna permisos</p>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-card">
                <form action="{{ route('roles.store') }}" method="POST">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="{{ route('roles.index') }}" class="bg-zinc-700 hover:bg-zinc-600 text-white font-medium py-3 px-6 rounded-lg transition-colors">
                            Cancelar
                        </a>
                    </div>
                </form>
