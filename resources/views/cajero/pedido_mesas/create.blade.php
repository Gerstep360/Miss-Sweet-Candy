<x-layouts.app :title="__('Crear Pedido')">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="dashboard-card mb-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1 class="text-2xl font-bold text-white mb-2">Crear Nuevo Pedido</h1>
                        <p class="text-zinc-300">Registra un nuevo pedido en mesa</p>
                    </div>
            ...
            <form action="{{ route('pedido-mesas.store') }}" method="POST" 
                  x-data="pedidoForm()" 
        ...
        function pedidoForm() {
            return {
                ...
                handleProductsSelected(event) {
                    console.log('Productos recibidos:', event.detail);
                    this.items = [...event.detail];
                    this.$nextTick(() => {
                        console.log('Items actualizados en create:', this.items);
                    });
                },
                ...
                updateItems() {
                    ...
                    this.$nextTick(() => {
                        console.log('Items sincronizados desde modal:', this.items);
                    });
                },
