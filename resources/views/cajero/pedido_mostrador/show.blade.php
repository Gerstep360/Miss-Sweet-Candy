{{-- filepath: c:\Users\German\Documents\Proyectos\PHP\Cafeteria\cafeteria\resources\views\cajero\pedido_mostrador\show.blade.php --}}
<x-layouts.app :title="__('Detalle del Pedido Mostrador')">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="dashboard-card mb-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1 class="text-2xl font-bold text-white mb-2">Pedido Mostrador #{{ $pedido->id }}</h1>
                        <p class="text-zinc-300">Detalle del pedido para llevar</p>
                    </div>
