      ...
      <section class="mt-6 sm:mt-8 bg-amber-500/10 border border-amber-500/20 rounded-xl sm:rounded-2xl p-4 sm:p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4">
          ...
          <button onclick="openProductModal()"
                  class="px-4 py-2 bg-amber-500 hover:bg-amber-400 active:bg-amber-600 text-black text-sm sm:text-base font-semibold rounded-lg transition-colors min-h-[44px] w-full sm:w-auto touch-manipulation">
            Cambiar
          </button>
          @endcan
        </div>
          ...
          <div class="md:col-span-6">
            ...
            <div class="flex items-center gap-3 sm:gap-4 flex-wrap">
              @if($especialHoy->tieneDescuento())
                ...
                <span class="bg-red-500 text-white text-xs sm:text-sm px-2 sm:px-3 py-1 sm:py-1.5 rounded-full font-bold">
