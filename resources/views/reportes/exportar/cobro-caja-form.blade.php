{{-- filepath: resources/views/reportes/exportar/cobro-caja-form.blade.php --}}
<x-layouts.app :title="__('Exportar Reporte de Cobros')">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-white flex items-center gap-2">
                            ...
                            Reporte de Cobros de Caja
                        </h1>
                        <p class="text-zinc-400">Configura y exporta el reporte de cobros</p>
                    </div>
                </div>
            </div>
            ...
            <form id="export-form" method="POST" class="space-y-6">
                    ...
                    <div id="custom-filters" class="space-y-4 hidden">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="metodo_pago" class="w-full px-4 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-white focus:ring-2 focus:ring-amber-500 focus:border-transparent">
                ...
                <div class="dashboard-card p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <button type="submit" data-action="{{ route('reportes.exportar.cobro-caja.pdf') }}" class="export-btn px-6 py-4 bg-red-500 hover:bg-red-400 text-white font-semibold rounded-lg transition-all flex items-center justify-center gap-2">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                            </svg>
                            Exportar PDF
                        </button>
                        <button type="submit" data-action="{{ route('reportes.exportar.cobro-caja.excel') }}" class="export-btn px-6 py-4 bg-green-500 hover:bg-green-400 text-white font-semibold rounded-lg transition-all flex items-center justify-center gap-2">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
