{{-- filepath: resources/views/reportes/exportar/pedidos-form.blade.php --}}
<x-layouts.app :title="__('Exportar Reporte de Pedidos')">
            ...
            <div class="dashboard-card mb-6">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-zinc-400">Configura y exporta el reporte de pedidos</p>
                    </div>
                </div>
            </div>
            ...
            <form id="export-form" method="POST" class="space-y-6">
                ...
                <div class="dashboard-card">
                    ...
                    <div id="custom-filters" class="space-y-4 hidden">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-zinc-300 mb-2">Tipo de Pedido</label>
                                <select name="tipo_pedido" class="w-full px-4 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-white focus:ring-2 focus:ring-amber-500 focus:border-transparent">
                                    <option value="">Todos</option>
                                    <option value="mesa">Mesa</option>
                                    <option value="mostrador">Mostrador</option>
                                    <option value="web">En Línea</option>
                                </select>
                            </div>
                            <div>
                ...
                <div class="dashboard-card p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <button type="submit" data-action="{{ route('reportes.exportar.pedidos.pdf') }}" class="export-btn px-6 py-4 bg-red-500 hover:bg-red-400 text-white font-semibold rounded-lg transition-all flex items-center justify-center gap-2">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                            </svg>
                            Exportar PDF
                        </button>
                        <button type="submit" data-action="{{ route('reportes.exportar.pedidos.excel') }}" class="export-btn px-6 py-4 bg-green-500 hover:bg-green-400 text-white font-semibold rounded-lg transition-all flex items-center justify-center gap-2">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
