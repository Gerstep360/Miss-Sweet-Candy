{{-- filepath: resources/views/reportes/exportar/promociones-form.blade.php --}}
<x-layouts.app :title="__('Exportar Reporte de Promociones')">
            ...
            <div class="dashboard-card mb-6">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-zinc-400">Configura y exporta el reporte de promociones</p>
                    </div>
                </div>
            </div>
            ...
            <form id="export-form" method="POST" class="space-y-6">
                ...
                <div class="dashboard-card">
                                ...
                                <div class="peer-checked:border-amber-500 peer-checked:bg-amber-500/10 w-full border-2 border-transparent rounded-lg p-3 transition-all">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-zinc-400">Todas las promociones</p>
                                        </div>
                                    </div>
                                </div>
                            </label>
                    ...
                    <div id="custom-filters" class="space-y-4 hidden">
                        <div>
                            ...
                            <select name="estado" class="w-full px-4 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-white focus:ring-2 focus:ring-amber-500 focus:border-transparent">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-zinc-300 mb-2">Vigencia</label>
                            <select name="vigencia" class="w-full px-4 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-white focus:ring-2 focus:ring-amber-500 focus:border-transparent">
                                <option value="">Todas</option>
                ...
                <div class="dashboard-card p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <button type="submit" data-action="{{ route('reportes.exportar.promociones.pdf') }}" class="export-btn px-6 py-4 bg-red-500 hover:bg-red-400 text-white font-semibold rounded-lg transition-all flex items-center justify-center gap-2">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                            </svg>
                            Exportar PDF
                        </button>
                        <button type="submit" data-action="{{ route('reportes.exportar.promociones.excel') }}" class="export-btn px-6 py-4 bg-green-500 hover:bg-green-400 text-white font-semibold rounded-lg transition-all flex items-center justify-center gap-2">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
